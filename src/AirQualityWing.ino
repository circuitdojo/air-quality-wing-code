...
// Logger settings
SerialLogHandler logHandler(115200, LOG_LEVEL_ERROR, {{"app", LOG_LEVEL_WARN},});
...
void setup()
{
  ...
  AirQualityWingSettings_t defaultSettings =
      {
          ...
          true,                 //Has Si7021
          true,                 //Has SGP30
          UNUSED_PIN,           //CCS811 address
          UNUSED_PIN,           //CCS811 intpin
          UNUSED_PIN,           //CCS811 rst pin
          UNUSED_PIN,           //CCS811 wake pin
          HPMA1150_EN_PIN       //HPMA int pin
      };
#endif
  ...
  // Startup message
  Serial.println("Air Quality Wing for Particle & Feather");
}
